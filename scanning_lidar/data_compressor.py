...
time_interval = 10;  # time to let files complete writing before processing, 2x lidar output interval suggested
...
def main():
    # files that have been in /raw_data directory for over time_interval minutes
    files_to_compress = []  # use dictionary if tons and tons of files
    
    while(True):
        
        # loop through all files that have been in /raw_data directory for over time_interval minutes
        ...
        # sleeps for time_interval
        sleep(60 * time_interval);
